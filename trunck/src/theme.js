...
module.exports = {
 ...
 '@list-font-size': fontSize24,
  ...
  //任务模块分类字号
  '@task-modular-font-size': fontSize20,
  //二标题 ||  分类 类型 字号
  ...
  '@white-color': '#fff',
  //次文本色
  '@text-font-color-secondary': grey5,
  //主文本色
  '@text-font-color': grey8,
  //三级文本色
  '@text-font-color-third': grey4,
  ...
  '@border-color': grey3,
  //学科选中
  '@subject-selected': yellow5,
  //题目标题背景|| 录入新题目的小标题背景
  '@topic-title-bg': blue1,
  //添加课程分步提示语背景
